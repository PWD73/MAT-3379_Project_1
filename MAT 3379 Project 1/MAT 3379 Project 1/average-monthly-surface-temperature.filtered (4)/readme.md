...
This data package contains the data that powers the chart ["Average monthly surface temperature"](https://ourworldindata.org/grapher/average-monthly-surface-temperature?tab=line&time=2000-08-15..2023-11-15&country=~USA&mapSelect=~CAN&overlay=download-data&v=1&csvType=filtered&useColumnShortNames=false) on the Our World in Data website. It was downloaded on January 28, 2026.
